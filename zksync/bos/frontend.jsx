            ...
            <p>
                {allQuestions.map((name, index) => (
                    <p>
                        ...
                        <img height="20" src="https://user-images.githubusercontent.com/128217157/270274380-89e98ae0-f7f0-4daa-a7b2-3cc414fa6306.png" />
                        <b style={{ color: "green" }}>{countVotes(state.getVotes[index][0])}</b>

                        <img height="20" src="https://user-images.githubusercontent.com/128217157/270274279-208a1236-2ad0-487f-a830-08b8fee9fdc3.png" />
